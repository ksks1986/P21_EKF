...
*/
	...
	float nx2 =        dt2 * noise_ax;
	float nx3 = 0.50 * dt3 * noise_ax;
	float nx4 = 0.25 * dt4 * noise_ax;

	float ny2 =        dt2 * noise_ay;
	float ny3 = 0.50 * dt3 * noise_ay;
	float ny4 = 0.25 * dt4 * noise_ay;
